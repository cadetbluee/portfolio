...
### 11. MEOVA만 Trouble Shooting이 비어 있습니다
...
| 2 | **1번 — 동행 추가** | ⬜ 다음 — `src/data/projects.ts` 배열에 항목 하나 추가 |
| 3 | **2·3·4번 — Skills / About / Contact** | ⬜ 내용 축의 핵심 |
| 4 | 6·9번 — Header 정리, README | ⬜ |
| 5 | 10·11·13·14번 | ⬜ 여유 있을 때 |
