...
| [PushOfLife](pushoflife.md) | 응급 상황 자동 감지 + CPR 실시간 피드백 | 2024.10~11 | FE/Mobile, 디자인, 기획 | 🏆 자율 프로젝트 결선 1위 |
...
| [MEOVA](meova.md) | 태그 기반 SNS 영화 추천 플랫폼 | 2024.05 | Full-stack, 디자인, 기획 | 🏆 관통 프로젝트 최우수상 |
